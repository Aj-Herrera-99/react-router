...
function Form({ children, onSubmit }) {
    return (
        <form
            onSubmit={onSubmit}
            className="absolute top-1/2 -translate-y-1/2 z-50 left-1/2 -translate-x-1/2 flex flex-col gap-3 p-4 text-white rounded-md bg-slate-700 [&_input]:text-black max-w-[90vw]"
        >
            {children}
        </form>
    );
